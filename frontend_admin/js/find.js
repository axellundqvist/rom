...
function selectDrink(id) {
    ...
    $.getJSON("https://sundsvalls-rom.herokuapp.com/drinks/" + id, function(data) {
...
function update(id) {
    ...
    $.ajax({
        type: 'PUT',
        url: `https://sundsvalls-rom.herokuapp.com/drinks/${id}`,
        data: package,
        success: function (data) {
            alert('Update was successfull!');
            window.location = "https://axellundqvist.se/romklubben/index.html";
        }
    });
